...
/** Pull every row out of the Notion Clients database (quota, shot count, remaining, contract months). */
  ...
  do {
    ...
    for (const page of resp.results) {
      ...
      results.push({
        ...
        active: getCheckbox(props[CLIENT_PROP.active]),
        quota: getNumber(props[CLIENT_PROP.quota]),
        shot: getNumber(props[CLIENT_PROP.shot]),
        remaining: getNumber(props[CLIENT_PROP.remaining]),
        startMonth: getPlainText(props[CLIENT_PROP.startMonth]),
        currentMonth: getPlainText(props[CLIENT_PROP.currentMonth]),
      });
    }
